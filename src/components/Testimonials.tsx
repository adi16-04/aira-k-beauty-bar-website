...
const testimonials = [
  ...
  {
    quote: "The team at Aira K is incredibly skilled and attentive. My hair transformation exceeded all expectations.",
    name: "P. Reddy",
    role: "Salon Client",
  },
  {
    quote: "From the bridal makeup to the nail art, everything was flawless. Highly recommend Aira K Beauty Bar.",
    name: "R. Mehta",
    role: "Bridal Client",
  },
];
