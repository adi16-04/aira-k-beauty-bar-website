        ...
        >
          ...
          <div className="reveal" style={{ position: "relative" }}>
            ...
            <img
              ...
              alt="Professional hairstylist at work in Aira K Beauty Bar"
              loading="lazy"
              style={{
                width: "100%",
                height: 540,
          ...
          <div>
            ...
            >
              Aira K Beauty Bar is a premium unisex salon in the heart of Jayanagar, Bangalore — a sanctuary where every client is treated with care, expertise, and genuine attention to detail.
            </p>
            <p
              className="reveal reveal-delay-3"
